...
public class twcAppLaunch {
	...
	public static <WebElement> void main(String[] args) throws MalformedURLException, Exception {
		// TODO Auto-generated method stub

	DesiredCapabilities caps=new DesiredCapabilities();
	
	caps.setCapability("deviceName", "Samsung");
	caps.setCapability("plotformName", "Android");
	caps.setCapability("plotformVersion", "8.0.0");
